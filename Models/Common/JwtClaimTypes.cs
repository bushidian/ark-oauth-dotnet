namespace Ark.OAuth.Models
{
  //
    ...
    public static class JwtClaimTypes
    {
        ...
        //     Context Class Reference value that identifies the Authentication Context Class
        //     that the authentication performed satisfied. /// The value "0" indicates the
        //     End-User authentication did not meet the requirements of ISO/IEC 29115 level
        //     1. /// Authentication using a long-lived browser cookie, for instance, is one
        //     example where the use of "level 0" is appropriate. /// Authentications with level
        //     0 SHOULD NOT be used to authorize access to any resource of any monetary value.
        //     /// (This corresponds to the OpenID 2.0 PAPE nist_auth_level 0.) /// An absolute
        //     URI or an RFC 6711 registered name SHOULD be used as the acr value; registered
        //     names MUST NOT be used with a different meaning than that which is registered.
